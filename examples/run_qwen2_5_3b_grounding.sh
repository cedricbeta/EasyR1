...
DATASET_PATH=${2:-"/home/chendong/video-rl/EasyR1/data/video_grounding"}  # Second argument or default
...
# Run training using the locally saved Parquet files from the train and test splits
